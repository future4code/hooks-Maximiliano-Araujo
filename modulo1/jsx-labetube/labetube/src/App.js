import labeLogo from '../src/images/labeLogo.png'
import './App.css';
  ...
  return (
    <div>
      <div className="tela-inteira">
        <header>
        <img className="labeLogo" src={labeLogo} alt="labeLogo"/>
          <h1>LabTube</h1>          
          <input className="button" type="text" placeholder="Busca" id="campoDeBusca" />
        </header>
        <main>
